...
namespace ProjectF.WebUI.AuthProviders
{
    public class AuthStateProvider : AuthenticationStateProvider
    {
        ...
        public AuthStateProvider(HttpClient httpClient, ILocalStorageService localStorage) 
            => (_httpClient, _localStorage, _anonymous) 
            = (httpClient, localStorage, new AuthenticationState(new ClaimsPrincipal(new ClaimsIdentity())));
